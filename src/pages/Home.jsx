...
const Home = () => {
  ...
  const PHONE = "(475) 276-4824";
  const EMAIL = "TRUERESILIENCEFREIGHT@GMAIL.COM";
  const MC_NUMBER = "1737713";
  const DOT_NUMBER = "4417035";
  const HOME_BASE = "699 HIGH RIDGE RD STAMFORD, CT 06905-2304";
  ...
  const handleDownload = (docName) => {
    ...
    fetch(filePath)
      ...
      .then(blob => {
        ...
        link.href = url;
        link.setAttribute('download', `${docName.replace(/\s+/g, '_')}_TRF.jpg`);
  ...
  const handleUnlock = (e) => {
    e.preventDefault();
    if (accessCode.toUpperCase() === 'TRF2026') {
      setIsUnlocked(true); 
      setShowModal(false); 
      setError('');
    } else { 
      setError('Invalid Code. Try "TRF2026"'); 
    }
  };
  ...
  const handleQuoteRequest = (e) => {
    ...
    const subject = encodeURIComponent(`Quote Request: ${quoteOrigin} to ${quoteDest} - TRUE RESILIENCE FREIGHT LLC`);
    const body = encodeURIComponent(
      `Hi Gregory,\n\nI am reaching out to request a quote for a load moving from ${quoteOrigin} to ${quoteDest}.\n\nEquipment Required: 26ft Box Truck\nCarrier: TRUE RESILIENCE FREIGHT LLC (MC# ${MC_NUMBER})\n\nPlease let me know your availability and rate for this lane.\n\nBest regards,`
    );
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in-up z-20">
            ...
            <h1 className="text-5xl md:text-7xl font-black leading-none tracking-tight text-gray-900">
              <span className="text-gradient bg-clip-text text-transparent bg-gradient-to-r from-red-600 to-red-400">TRUE RESILIENCE</span><br /> FREIGHT LLC
            </h1>
            
            <p className="text-xl text-gray-600 max-w-lg leading-relaxed">
              <strong>NORTHEAST ↔ MID-ATLANTIC Specialist.</strong> <br/>
          ...
          <div className="relative w-full h-full animate-fade-in-up" style={{animationDelay: '0.2s'}}>
            <div className="clip-trap relative z-10 bg-gray-800 aspect-[4/5] shadow-2xl group overflow-hidden">
              <img 
                src={heroTruck} 
                alt="Gregory Trucking LLC 26ft International Box Truck" 
        ...
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-16 items-center relative z-10">
           {/* Image Side */}
            <div className="relative group hover-lift">
              ...
              <img 
                src={driverImg} 
                alt="Gregory Baptiste - Owner Operator" 
              ...
              <div className="absolute bottom-6 left-6 bg-black/80 backdrop-blur-md px-6 py-4 border-l-4 border-red-600 shadow-lg">
                <p className="font-black text-xl uppercase text-white">Gregory Baptiste</p>
          ...
          <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed border-l-4 border-red-200 pl-4">
                "I operate under my own authority to kill the anxiety brokers feel when they hang up the phone. When you book TRUE RESILIENCE FREIGHT LLC, you aren't talking to a dispatcher—you're talking to the driver. 
                <br/><br/>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="relative group clip-trap bg-gray-200 shadow-xl overflow-hidden h-[400px] lg:h-auto">
              <img 
                src={truckRear} 
                alt="Gregory's 3000lb Anthony Liftgate Proof" 
                className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
              />
      ...
      <section className="py-20 bg-gray-900 text-white clip-angle">
        <div className="max-w-7xl mx-auto px-4">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                { name: "Jason M.", company: "TQL", text: "Gregory was excellent. Perfect for that tricky LTL run we had. Tracking was on point." },
      ...
      <section id="lanes" className="py-20 bg-white border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-gray-500 mb-12 max-w-2xl mx-auto">
                Specializing in NORTHEAST ↔ MID-ATLANTIC lanes. Open to structured backhauls or dedicated regional runs.
            </p>

            <div className="flex flex-wrap justify-center gap-4">
              {['CONNECTICUT', 'NEW YORK', 'NEW JERSEY', 'PENNSYLVANIA', 'MASSACHUSETTS', 'RHODE ISLAND', 'DELAWARE', 'MARYLAND'].map((state, index) => (
                <span 
                  key={state} 
          ...
          <div className="bg-[#111827] clip-trap p-8 md:p-12 relative overflow-hidden shadow-2xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
              <div className="text-left space-y-4 text-white">
                ...
                <p className="text-gray-400 text-lg leading-relaxed">Specializing in <strong>NORTHEAST ↔ MID-ATLANTIC</strong> lanes. Get a direct response from the owner-operator within minutes.</p>
              </div>
              <div className="bg-white p-1 clip-trap">
                <form className="grid grid-cols-1 sm:grid-cols-2 gap-2 p-2 bg-white">
                  ...
                  >
                    <option value="">Origin (Northeast)</option>
  <option>CT - Connecticut (HQ)</option>
  ...
  <option>MA - Massachusetts</option>
                  ...
                  <select
                    ...
                    className="bg-gray-100 p-4 font-bold text-gray-700 outline-none focus:bg-gray-200 transition-colors cursor-pointer"
                  >
                    <option value="">Destination (Mid-Atlantic / Northeast)</option>
